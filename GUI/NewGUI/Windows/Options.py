...
SWITCH_STARTING_CENTER = (CENTER[0], CENTER[1] + SWITCH_SIZE[1] / 2) if NUMBER_OF_SWITCHES % 2 == 1 \
    else (CENTER[0], CENTER[1] - SWITCH_HEIGHT_TOTAL * 0.75 + SWITCH_SIZE[1] / 2)
...
BACKGROUND_SIZE = (SWITCH_SIZE[0] * 1.8, SWITCH_HEIGHT_TOTAL * 4)
...
def add_switches(screen, clock):
    ...
    functions = [mute_sound, mute_music, None]
    arguments = [Constants.SOUND, Constants.MUSIC, None]
    text = ["SOUND", "MUSIC", "AAA"]
